...
foreach ($houses as $house_key => $house_info) {
    ...
    if ($stats['student_count'] === 0 && isset($default_student_counts[$house_key])) {
        $stats['student_count'] = $default_student_counts[$house_key];
    }
